...
### Live demo · what the output looks like

Live demo at **https://wanshuiyin.github.io/** — generated by this skill from a CV + the maintainer's previous manual page as editorial reference. Three sections from the rendered page:

<p align="center">
  <img src="assets/homepage-showcase/hero.png" width="78%" alt="Header + Bio + Research — 240px headshot, bilingual H1, multi-line contact, single-paragraph bio + research interests + education">
  <br>
  <em>Header · bilingual H1 · multi-line contact · bio · research interests · education</em>
</p>

<p align="center">
  <img src="assets/homepage-showcase/aris-featured.png" width="78%" alt="ARIS Featured project section — name, credibility badges, link cluster, hero SVG floated right, sub-projects, open problems, then News with star-history badge">
  <br>
  <em>ARIS Featured section — hero SVG floats right, text wraps until image ends then full-width continues with sub-projects + open problems. News below with embedded star-history badge.</em>
</p>

<p align="center">
  <img src="assets/homepage-showcase/publications.png" width="78%" alt="Publications — 5 topic groups (MoE/Pretraining / SFT / Post-Training / Sampling / RL Theory), per-paper thumbnails, universal blue left-border, spotlight 4px border, blue-quoted description blurbs for industry-internship papers (DFS-GRPO Meituan, Contrastive 3D Tencent)">
  <br>
  <em>Publications — 5 topic groups · per-paper thumbnails · universal blue left-border · spotlight gets thicker border · blue-quoted description blurbs for industry-internship papers</em>
</p>
...
flowchart LR
    ...
    MH["🌐 Manual<br/>Homepage URL<br/>(editorial)"] -.optional.-> Agent
    AD["🖼 Assets<br/>directory<br/>(visual)"] -.optional.-> Agent

    Init --> Handoff["📋 EXTRACTION_HANDOFF.md"]
    Handoff --> Agent["🤖 Calling LLM agent<br/>fills extraction.json"]
    Agent --> Finalize["aris-homepage finalize"]
    Finalize --> Sources["✋ Editable source files:<br/>profile.yml · publications.bib<br/>bio.md · news.md"]

    Sources --> Render["aris-homepage render<br/>--persona theory-minimal"]
    Render --> DBLP{"🔍 Layer-1: DBLP/arXiv<br/>fact-check (always)"}
    DBLP -->|PASS / WARN| HTML["📄 index.html<br/>+ audit-report.md"]
    DBLP -->|BLOCKED| Fix{"Fix or<br/>--override-all?"}
    Fix -->|fix| Sources
    Fix -->|override| HTML

    HTML -.optional.-> CodexL2["🤝 Layer-2: Codex MCP<br/>adversarial review"]
    HTML -.optional.-> GeminiL2["👁 Layer-2: Gemini<br/>visual critique"]
    HTML --> Ship["🚀 Deploy:<br/>GitHub Pages · S3 · anywhere"]
```
